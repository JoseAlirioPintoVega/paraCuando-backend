...
export function Footer() {
  return (
    <div className="footer flex justify-center bg-[url(/footer-banner.png)] bg-cover bg-no-repeat bg-center h-screen max-h-80 bottom-0">
      <div className="m-0  relative flex items-center w-[350px] sm:w-[435px]">
        ...
        />
        <p className="input_text absolute -inset-y-0 right-4 flex items-center ">
          <Lupa />
        </p>
      </div>
    </div>
